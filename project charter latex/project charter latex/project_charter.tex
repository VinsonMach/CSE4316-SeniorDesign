...
%\end{versionhistory}
\begin{versionhistory}
  	\vhEntry{0.1}{09.24.2021}{KB}{Document Creation}
  	\vhEntry{0.2}{10.01.2021}{KB|MB|XH|VM|LS|PZ}{Complete Draft 1}
  	\vhEntry{0.3}{10.24.2021}{KB|MB|XH|VM|LS|PZ}{Sprint 2 Update}
  	\vhEntry{0.4}{11.12.2021}{KB|MB|XH|VM|LS|PZ}{Sprint 3 Update}
  	\vhEntry{0.5}{11.25.2021}{KB|MB|XH|VM|LS|PZ}{Sprint 4 Update}
\end{versionhistory}
\newpage
